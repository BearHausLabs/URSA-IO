...
public class DeviceAvailabilityController {
    ...
    private static final StructuredEventLogger log = StructuredEventLogger.of(StructuredEventLogger.getCommonServiceName(), "DeviceAvailabilityController", LOGGER);
